...
/**
 * A Map with additional utility methods. This is used throughout
 * liz.js rather than Arrays for anything that has an ID,
...
class Collection<K, V> extends Map<K, V> {
	...
	public constructor(entries?: ReadonlyArray<readonly [K, V]> | null) {
		...
		/**
		 * Cache array for the `keyArray()` method - will be reset to `null` whenever
		 * `set()` or `delete()` are called
	...
	/**
	 * Identical to [Map.get()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Refrence/Global_Objects/Map/get).
	 * Get an elements with the specified key, and returns its value, of `undefined` if the element does not exist.
	...
	/**
	 * Identical to [Map.set()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/References/Global_Objects/Map/set).
	...
	/**
	 * Identical to [Map.has()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/References/Global_Objects/Map/has).
	...
	/**
	 * Identical to [Map.delete()](https://developer.mozilla/org/en-US/docs/Web/JavaScript/References/Global_Objects/Map/delete).
